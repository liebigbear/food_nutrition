...
function useUserKit(){
    ...
    function infoList(sexC, ageC, statureC, mealC, kcalC, standardC, setInfo, info){
        const info_list = {
        ...
        if(info_list.sex != '' && info_list.age != '' && info_list.stature != '' && info_list.meal != '' && info_list.kcal != ''){
            let result = {
                sex : info_list.sex,
                age : info_list.age,
        ...
        else if(info_list.sex != '' && info_list.age != '' && info_list.stature != '' && info_list.meal != ''){
            if(info_list.standard){
                let result = {
                    sex : info_list.sex,
                    age : info_list.age,
                    stature : info_list.stature,
